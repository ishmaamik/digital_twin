...
if __name__ == "__main__":
    ...
    print(all_acc)
    print(all_pwr)
    savemat('result/all_acc_train_on_transfer_uniform.mat', {'all_acc_train_on_transfer_uniform': all_acc})
    savemat('result/all_pwr_train_on_transfer_uniform.mat', {'all_pwr_train_on_transfer_uniform': all_pwr})
    print('done')
