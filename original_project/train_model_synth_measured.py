...
if __name__ == "__main__":
    ...
    print(all_acc)
    print(all_pwr)
    savemat('result/all_acc_train_on_synth_measured.mat', {'all_acc_train_on_synth_measured': all_acc})
    savemat('result/all_pwr_train_on_synth_measured.mat', {'all_pwr_train_on_synth_measured': all_pwr})
    print('done')
