...
# Note: this batch is deliberately restricted to exactly the 10 comparisons
# above per explicit request ("do some last few tasks"). The remaining 10
# pairs from the original 20-pair matrix (s7_to_s3, s7_to_s4,
# s7_to_s32straight, s32straight_to_s2/s3/s7/s33straight,
# s33straight_to_s2/s4/s32straight) are NOT run by this batch and remain
# for a possible future run if ever requested.
